...
const getData6 = index => {
  ...
  resultsObject[`${index}2`].result = populate(version3, version2, version1)
  resultsObject[`${index}3`].result = populate(version3, version1, version1)

  resultsObject[`${index}4`].result = populate(version6, version3, version1)
...
const getData7 = index => {
  ...
  resultsObject[`${index}1`].result = populate(version2, version5, version2)
  resultsObject[`${index}2`].result = populate(version2, version5, version3)
  resultsObject[`${index}3`].result = populate(version2, version5, version1)

  resultsObject[`${index}4`].result = populate(version3, version5, version2)
  resultsObject[`${index}5`].result = populate(version3, version5, version3)
  resultsObject[`${index}6`].result = populate(version3, version5, version1)

  resultsObject[`${index}7`].result = populate(version1, version5, version2)
  resultsObject[`${index}8`].result = populate(version1, version5, version3)
  resultsObject[`${index}9`].result = populate(version1, version3, version1)
...
const getData8 = index => {
  ...
  resultsObject[`${index}1`].result = populate(version1, version3, version1)
  resultsObject[`${index}2`].result = populate(version1, version6, version3)
