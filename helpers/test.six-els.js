...
const getData3 = index => {
  ...
  resultsObject[`${index}4`].result = populate(version5, version4, version3)
  ...
  resultsObject[`${index}10`].result = populate(version2, version2, version2)
  resultsObject[`${index}11`].result = populate(version3, version2, version3)
  ...
  resultsObject[`${index}17`].result = populate(version1, version1, version7)
...
const getData4 = index => {
  ...
  resultsObject[`${index}4`].result = populate(version7, version2, version1)
  resultsObject[`${index}5`].result = populate(version7, version1, version1)
  resultsObject[`${index}6`].result = populate(version7, version4, version1)
  ...
  resultsObject[`${index}16`].result = populate(version1, version2, version8)
  resultsObject[`${index}17`].result = populate(version2, version7, version7)
